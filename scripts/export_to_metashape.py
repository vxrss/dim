...
# Add scripts directory to path so metashape subpackage can be found
# when running this script directly (e.g. python scripts/export_to_metashape.py)
...
from metashape.metashape_from_dim import project_from_bundler
